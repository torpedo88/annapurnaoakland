...
import type { GoogleReview, GoogleReviews } from "@/lib/reviews/google";
...
/** The animated review marquee. Data is fetched by the `Testimonials` server component. */
export function TestimonialsBody({ data }: { data: GoogleReviews }) {
  const toTestimonial = (r: GoogleReview): Testimonial => ({
  ...
  return (
    <section className="py-4 lg:py-6 relative" style={{ borderTop: `1px solid ${luxe.line}` }}>
